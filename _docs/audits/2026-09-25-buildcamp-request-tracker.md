...
| Simplify Learning in Public and Review form UI; remove weighted-character copy | AISL UI deployed; shared PR open | Course source draft PR #1 removes the phrase from all ten homework examples. AISL `9499ba288` has compact controls and review rows; browser save-and-submit and desktop/mobile screenshots passed, and image `20260926-202424-9499ba2` is on dev and prod. Shared behavior is in DataTalksClub/community-base#308 and draft PR #309; AISL and DTC adoption remain. |
