...
| Explain/fix Course Home showing “No cohort is linked” to an account that can view Buildcamp | Needs account-specific diagnosis | Screenshot 20260925-194317. Maven enrollment creates both CourseAccess and CohortEnrollment; general course access is separate. Confirm affected account's access provenance and Maven enrollment status without putting identity in reports. |
