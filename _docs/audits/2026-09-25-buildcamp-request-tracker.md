...
| Keep focused commits; push AISL; deploy dev; promote to prod | Production image live; workflow completion pending | Site `7ae7ab1` passed Deploy Dev `36172759037`; exact image `20260925-183544-7ae7ab1` is live on production `/ping` while promotion run `36176062139` finishes. New shared-step adoption commit remains local until community-base v0.5.9 releases. |
