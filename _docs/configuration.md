...
Test: visit `/studio/settings/` and confirm 12 integration groups are listed (Stripe, Zoom, Email (SES), S3 Recordings, S3 Content Images, YouTube, GitHub App, Slack, Site, Analytics, Auth, Banner Generator).
