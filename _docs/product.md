...
| Stripe webhook | `/api/webhooks/payments` | Receives eight required Stripe events for immediate/delayed Checkout, subscription changes/deletion, monthly payment failure/recovery, and customer email sync | System | Shipped |
