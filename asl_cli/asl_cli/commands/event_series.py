...
SERIES_FLAGS = [
    ...
    click.option("--cadence", type=click.Choice(["weekly", "none"]), default=None,
                 help="'weekly' (generates a schedule) or 'none' (a plain "
                      "collection; day-of-week/start-time optional)."),
    click.option("--day-of-week", type=click.IntRange(0, 6), default=None,
                 help="0=Mon..6=Sun. Required for weekly; optional for none."),
    click.option("--start-time", default=None,
                 help="HH:MM or HH:MM:SS. Required for weekly; optional for none."),
