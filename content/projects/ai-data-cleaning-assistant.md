...
description: "A production-style app that automates messy CSV cleanup: upload a file, profile it, generate AI-backed cleaning steps, apply deterministic transformations, and download a cleaned dataset with a human-readable report. Turns a repetitive, error-prone task into a repeatable pipeline with tests, an API, and Cloud Run deployment—LLM as planner, cleaning engine deterministic for reliability."
date: "2025-12-15"
