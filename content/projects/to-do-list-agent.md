...
description: "A reference project from the AI Bootcamp—an agent that interacts with a simple to-do list application. Built with Lovable for the frontend and FastAPI (Python) for the backend. Uses the backend's OpenAPI spec so the model can create tools to get tasks or mark them complete, with Logfire for monitoring and pytest for testing."
date: "2025-12-15"
...
Reference project from the first cohort of the [AI Engineering Bootcamp](https://maven.com/alexey-grigorev/from-rag-to-agents), built to help students understand the requirements for a robust, end-to-end AI application.
