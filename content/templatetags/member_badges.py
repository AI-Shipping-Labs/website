...
TONE_CLASSES = {
    ...
    'success': 'bg-green-500/15 text-green-800 dark:text-green-400',
    'success_soft': 'bg-green-500/15 text-green-800 dark:text-green-400',
    'info': 'bg-blue-500/15 text-blue-800 dark:text-blue-400',
    'danger': 'bg-red-500/15 text-red-800 dark:text-red-400',
    'purple': 'bg-purple-500/15 text-purple-800 dark:text-purple-400',
    'warning': 'bg-yellow-500/15 text-yellow-800 dark:text-yellow-400',
}
