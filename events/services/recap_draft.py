...
RECAP_DRAFT_SYSTEM_PROMPT = (
    ...
    '- End with a "Try it yourself" section: concrete next steps — the '
    'exact tools, commands, links, and homework actually named in the '
    'transcript — so a member who missed the call can act on it without '
    'watching the recording. Omit the section only if the transcript '
    'gives nothing actionable.\n\n'
    'Hard rules:\n'
