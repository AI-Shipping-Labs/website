...
# Slug shape for ``Instructor.instructor_id`` — lowercase letters, digits,
# hyphens. Strict to make ids URL-safe and predictable; sync rejects ids
# that don't match this with a clear error rather than silently coercing.
