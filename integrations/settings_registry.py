...
INTEGRATION_GROUPS = [
    ...
    },
    {
        ...
        'keys': [
            ...
            {'key': 'SES_TRANSACTIONAL_FROM_EMAIL', 'is_secret': False, 'description': 'Sender address for required account and service email. Must be verified in SES.'},
            {'key': 'SES_PROMOTIONAL_FROM_EMAIL', 'is_secret': False, 'description': 'Sender address for campaigns, newsletters, and marketing email. Must be verified in SES.'},
