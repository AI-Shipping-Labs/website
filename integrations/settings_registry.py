...
INTEGRATION_GROUPS = [
    ...
    },
    {
        ...
        'keys': [
            ...
            {'key': 'SLACK_ANNOUNCEMENTS_CHANNEL_NAME', 'is_secret': False, 'description': 'Display name of the announcements channel (e.g. #announcements). Used in UI copy.', 'docs_url': '_docs/integrations/slack.md#slack_announcements_channel_name'},
