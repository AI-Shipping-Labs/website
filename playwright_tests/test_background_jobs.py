...
class TestScenario1StaffReviewsQueuedJobs:
    ...
    def test_staff_views_queued_tasks_and_admin_index(self, django_server, page):
...
class TestScenario2StaffMonitorsSuccessfulJobs:
    ...
    def test_staff_views_successful_task_list_and_detail(self, django_server, page):
        _clear_django_q_tables()
        _ensure_tiers()
        _create_staff_user("admin@test.com")
...
class TestScenario3StaffInvestigatesFailedJob:
    ...
    def test_staff_views_failed_task_list_and_detail(self, django_server, page):
        _clear_django_q_tables()
        _ensure_tiers()
        _create_staff_user("admin@test.com")
...
class TestScenario4StaffViewsRecurringSchedules:
    ...
    def test_staff_views_schedules_after_setup(self, django_server, page):
        _clear_django_q_tables()
        _ensure_tiers()
        _create_staff_user("admin@test.com")
...
class TestScenario5StaffTriggersManualSync:
    ...
    def test_staff_triggers_sync_from_dashboard(self, django_server, page):
...
class TestScenario6StaffReviewsSyncHistory:
    ...
    def test_staff_reviews_sync_history_and_returns(self, django_server, page):
        _clear_content_sources()
        _ensure_tiers()
        _create_staff_user("admin@test.com")
...
class TestScenario7StaffTriggersSyncAll:
    ...
    def test_staff_triggers_sync_all(self, django_server, page):
        _clear_content_sources()
        _ensure_tiers()
        _create_staff_user("admin@test.com")
...
class TestScenario8EmptyStateNoContentSources:
    ...
    def test_empty_state_shows_guidance(self, django_server, page):
        _clear_content_sources()
        _ensure_tiers()
        _create_staff_user("admin@test.com")
...
class TestScenario9NonStaffDeniedAccess:
    ...
    def test_non_staff_redirected_from_sync_and_django_q(self, django_server, browser):
        _ensure_tiers()
...
class TestScenario10AnonymousCannotAccessJobAdmin:
    ...
    def test_anonymous_redirected_from_job_admin_pages(self, django_server, page):
        _ensure_tiers()
...
class TestScenario11StaffNavigatesJobMonitoringViews:
    ...
    def test_staff_navigates_all_job_views(self, django_server, page):
        _clear_django_q_tables()
        _clear_content_sources()
        _ensure_tiers()
        _create_staff_user("admin@test.com")
