...
class TestScenario1StaffCreatesNewCampaign:
    ...
    def test_staff_creates_campaign_via_studio(self, django_server, browser):
...
class TestScenario3StaffSendsTestEmail:
    ...
    def test_send_test_email_via_admin(self, django_server, browser):
        """Given a user logged in as admin@test.com (Staff) and a draft
...
class TestScenario5StaffFiltersByStatus:
    ...
    def test_filter_campaigns_by_status_in_studio(self, django_server, browser):
...
class TestScenario6StaffSearchesBySubject:
    ...
    def test_search_campaigns_by_subject_in_studio(self, django_server, browser):
...
class TestScenario10NonStaffAccessDenied:
    ...
    def test_non_staff_cannot_access_campaign_list(self, django_server, browser):
