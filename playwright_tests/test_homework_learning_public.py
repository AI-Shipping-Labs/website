...
def test_public_links_are_configurable_saved_and_submitted(django_server, browser):
    ...
    page.get_by_label('Public link 1').fill('https://github.com/student/project')
    page.get_by_role('button', name='Add another link').click()
    page.get_by_label('Public link 2').fill('https://example.com/demo')
    page.get_by_role('button', name='Add another link').click()
    page.get_by_label('Public link 3').fill('https://example.com/learning')
