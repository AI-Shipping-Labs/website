...
class TestScenario1VisitorBrowsesProjects:
    ...
    def test_all_projects_visible_on_listing(self, django_server, page):
    ...
    def test_click_project_navigates_to_detail(self, django_server, page):
...
class TestScenario2VisitorFiltersByDifficulty:
    ...
    def test_difficulty_filter_narrows_results(self, django_server, page):
...
class TestScenario3VisitorCombinesDifficultyAndTagFilters:
    ...
    def test_tag_filter_then_combined_with_difficulty(self, django_server, page):
...
class TestScenario7BasicMemberUnlocksBasicProject:
    ...
    def test_basic_member_sees_full_project_content(self, django_server, browser):
...
class TestScenario8MemberSubmitsProject:
    ...
    def test_member_submits_project_via_api(self, django_server, browser):
...
class TestScenario9StaffApprovesSubmission:
    ...
    def test_staff_approves_project_in_studio(self, django_server, browser):
...
class TestScenario10StaffRejectsPublishedProject:
    ...
    def test_staff_rejects_published_project(self, django_server, browser):
...
class TestScenario11UnauthenticatedCannotSubmit:
    ...
    def test_anonymous_post_returns_error(self, django_server, page):
