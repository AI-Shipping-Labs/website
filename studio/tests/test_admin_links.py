...
ALLOWED_RUNTIME_LINES = {
    ...
    "_docs/audits/2026-09-07-website-code-audit-findings.md": {
    ...
    "_docs/audits/2026-09-07-website-complexity-reduction-plan.md": {
...
ALLOWED_TEST_SNAPSHOTS = {
    ...
    "accounts/tests/test_login_url_tag.py": _TestSnapshot(
        1, "b45aa3c452ea101e4c4e484f794b69f97186f48e355390650c0c9e0bd07935f6"
    ),
    "accounts/tests/test_member_api_keys.py": _TestSnapshot(
        1, "029fc63111c72ae18bbb447ad47fb60a8fa172f4638f292902c3f050816336fe"
    ),
    "accounts/tests/test_privacy.py": _TestSnapshot(
        2, "81f059aaed521bc1fece90a7c8a75df67259ebe2cef830c31f2a6c0d520bf192"
    ),
    "accounts/tests/test_return_context.py": _TestSnapshot(
        2, "11ec6e495175e9689421fd135457c9323e52b4718ff250963081097f26ce7ab9"
    ),
    "analytics/tests/test_middleware.py": _TestSnapshot(
        1, "488dc8587bb40348135db82bcba70f19983ffabc957c8e94373e8abbc5b407f5"
    ),
    ...
    "content/tests/test_video_player.py": _TestSnapshot(
        2, "b3aacb40249165ae734502fc087297bd2a0b7f10c1574a18ed48ad0b3a1a03a7"
    ),
    "content/tests/test_workshop_materials.py": _TestSnapshot(
        1, "c79282e039d20cabd83f8231fd7802512d697edd4286c4c5241267535839290e"
    ),
    "content/tests/test_workshops.py": _TestSnapshot(
        4, "51955b355f10f0fc5f3c965c7d4bec7800b79d6001e704cf0bb02a6565dff9e6"
    ),
    "crm/tests/test_onboarding_notify.py": _TestSnapshot(
        4, "d319143d3621501e9bdde6c95ea98dac1852c1a3b7d856e79c0cef13b1de6206"
    ),
    "email_app/tests/test_campaigns.py": _TestSnapshot(
        6, "7b041506e361664b0eafe41f254dde85b568218ee98ace63567f955029af82c0"
    ),
    "email_app/tests/test_newsletter.py": _TestSnapshot(
        4, "61107babc8c02b1de7ea4b9b62c656132a358771b47c05abd3d2824677c7e7bc"
    ),
    "events/tests/test_events.py": _TestSnapshot(2, "be47e91290d9a0ec91c522d53dbc122705650a94252cb0a3d819411a5c83f395"),
    "integrations/tests/test_announcement_banner.py": _TestSnapshot(
        1, "5dc3a0215dcd9297d76905e313b53043a9a83a26f46e2445bf539669c86c357f"
    ),
    "integrations/tests/test_github_sync.py": _TestSnapshot(
        5, "b82b9b3037d41103303caea9bc2ae89b8dfafd22c7d059329f0eef8fd6e683ce"
    ),
    "integrations/tests/test_middleware.py": _TestSnapshot(
        1, "779fa209e2cb99b13cc071123a93791513e0ed478bb72a49a66d520bd2ddac48"
    ),
    "integrations/tests/test_zoom.py": _TestSnapshot(
        5, "3ff816c37e7d6eb40c75363fe972116b4118605f7aa37eb544e365eca02122ee"
    ),
    "payments/tests/test_conversion_attribution.py": _TestSnapshot(
        4, "193417554ef6e9bdbd18d089819da6639d4e11691efc280c1103ee67ee5cb1fd"
    ),
    "payments/tests/test_tier.py": _TestSnapshot(3, "9dc3c3a23c0d60946ba0c6da96e9413aab02b19fed0aa95411133008f2d1299f"),
    "plans/tests/test_views_admin_link.py": _TestSnapshot(
        6, "8c4b7c60bed15b24ba7a41aee1de89037f2ce902b368f98542931d8f3dda0f65"
    ),
    "plans/tests/test_views_ask_team.py": _TestSnapshot(
        4, "16e93a82380ffab7815f846e5b4affb6a92f37a4c39e5aa48b1dd9bae59bc262"
    ),
    "playwright_tests/test_articles_blog.py": _TestSnapshot(
        2, "6c58ee61763e6d67b37d6afd3a5b76818cd2fb1b4d7b2487db1009b634e90df6"
    ),
    "playwright_tests/test_community_slack.py": _TestSnapshot(
        3, "6aac05d47515cee586d5023703d637bca3b2e6d764ff488f4079234e8b67d78f"
    ),
    "playwright_tests/test_content_comment_notifications.py": _TestSnapshot(
        1, "0f999fcd42fa5ce40d30892bf7d75b9666fb421560ec8998d5cd764464391a61"
    ),
    "playwright_tests/test_course_admin.py": _TestSnapshot(
        1, "0ce849e07a6aca0172be476be49c4162d53878247d0a14e75af0ce8980e0a984"
    ),
    "playwright_tests/test_crm_activity_context_1054.py": _TestSnapshot(
        1, "728a4e08289a33546a17cf99b716403519e8bb5b3168626471ffeffc5cfc2fa3"
    ),
    "playwright_tests/test_event_url_canonicalization_673.py": _TestSnapshot(
        1, "6cb8c468d606445e798e455ff6af359a084d744f9f030bc5ad215666c5fd4018"
    ),
    "playwright_tests/test_github_content_sync.py": _TestSnapshot(
        6, "13913b9d7d3dbdcb387260711417b5061a0978ada80782d57a322a63fb16fc69"
    ),
    ...
    "playwright_tests/test_search_indexing_policy_1379.py": _TestSnapshot(
        1, "b9542ca64e5a55c190caff0f0756b6b3394f085652be66fb778863c3ff3b067f"
    ),
    "playwright_tests/test_sprint_member_actions_585.py": _TestSnapshot(
        1, "2e90a5deaf691064253bfee2f3aa196c80b88b4ef00506c92e3f49c4d493343d"
    ),
    "playwright_tests/test_studio_campaigns.py": _TestSnapshot(
        1, "9df0b5a4a2b2f01adbda2d2e2e3c2028536184909daf3d70b7efbb9a2e83fe35"
    ),
    "playwright_tests/test_studio_edit_button.py": _TestSnapshot(
        2, "a03e06e4c50f385f193a07aa92c0005ac72d8deff33b38e42237429781f23940"
    ),
    "playwright_tests/test_studio_user_activity_public_links_1052.py": _TestSnapshot(
        1, "728a4e08289a33546a17cf99b716403519e8bb5b3168626471ffeffc5cfc2fa3"
    ),
    "playwright_tests/test_studio_user_crm_overview.py": _TestSnapshot(
        2, "c94c38637cea8d445a89a5715dbf4b7ecaec2fac2104297375644bff0c829d99"
    ),
    "playwright_tests/test_studio_user_detail_layout_586.py": _TestSnapshot(
        4, "158abd4bc59a667eea7d02d6c89c9aeddd737f00be357f36477f6098f13781bf"
    ),
    "playwright_tests/test_studio_user_slack_id.py": _TestSnapshot(
        1, "8186514d6acee9f8b3e626ae69f7affe6660c5a7440c290df8f497e71dd40c95"
    ),
    "playwright_tests/test_utm_analytics.py": _TestSnapshot(
        1, "3c3bc3c649f6670f9bf5fc8801100d8d4ce0b6a99875839bd80be2f1104bece9"
    ),
    "playwright_tests/test_video_player.py": _TestSnapshot(
    ...
    "studio/tests/test_ses_events.py": _TestSnapshot(
        3, "0d97ca463cd38dc37339abec15297976566001c21765d1ff9f3d42ccb8ee1cfe"
    ),
    "studio/tests/test_sprints.py": _TestSnapshot(
    ...
    "studio/tests/test_user_detail_layout_586.py": _TestSnapshot(
        4, "2fae30ac097bc44cfce004b65079422613b036358814bd7f606d47d1ff1c8cdf"
    ),
    "studio/tests/test_user_slack_id.py": _TestSnapshot(
        1, "5a08c0236e1c6f4a771dc4334fc103d695f17a52e0d23ef02e7683bb2b09e9d9"
    ),
    "studio/tests/test_utm_analytics.py": _TestSnapshot(
        1, "50367ce0e4de79c23336ff4df37ebbbeeb98f8a5fffb0689519d96864fce6ed5"
    ),
    "tests/test_search_indexing_policy_1379.py": _TestSnapshot(
        3, "28f4eb8fa33c194cfdcba6de0c105163e8a8f98bc83ce4ea0887279ee8097176"
    ),
    "triggers/tests/test_studio_views.py": _TestSnapshot(
        1, "e95318920e60d71ab0bc3d9ab1b816ab128cff1b4a413ce78bf6ae79847ec588"
    ),
...
def _is_test_path(relative):
    return relative.parts[0] in {"tests", "playwright_tests"} or ("tests" in relative.parts)
...
def _matched_lines(path):
    return sorted(line.strip() for line in path.read_text(encoding="utf-8").splitlines() if _line_is_guarded(line))
...
def _allowlist_errors():
    ...
    if self_path is None:
        ...
        if marker_count != 1:
            errors.append(
                f"guarded policy marker count changed: {SELF_PATH}: expected 1, found {marker_count}",
            )
    ...
    for relative_name, allowed_lines in sorted(ALLOWED_RUNTIME_LINES.items()):
        ...
        if _is_test_path(relative):
            ...
            continue
        current = Counter(line.strip() for line in path.read_text(encoding="utf-8").splitlines())
        for expected_line in sorted(allowed_lines):
            if not _line_is_guarded(expected_line):
                errors.append(
                    f"allowlist line has no guarded marker: {relative_name}: {expected_line}",
                )
...
def _find_violations():
    ...
    for relative, path in _scanned_files():
        ...
        if _is_test_path(relative):
            ...
            if snapshot is not None and len(matches) == snapshot.count and _snapshot_digest(matches) == snapshot.digest:
                continue
        else:
