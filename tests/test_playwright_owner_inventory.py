...
class CurrentRepositoryInventoryTests(SimpleTestCase):
    ...
    issue_1566_owners = frozenset({
        ...
        "test_staff_follows_distinct_dashboard_attention_to_maven_occurrences",
        "playwright_tests/test_maven_attention_1566.py::"
        "test_staff_distinguishes_fresh_failed_from_stalled_and_clears_empty_filter",
        "playwright_tests/test_maven_attention_1566.py::"
    ...
    issue_1568_owners = frozenset({
        ...
        "playwright_tests/test_maven_occurrences_api_1568.py::"
        "test_staff_gets_conflict_instead_of_duplicate_fresh_running_attempt",
        "playwright_tests/test_maven_occurrences_api_1568.py::"
    ...
    issue_1770_owners = frozenset({
        "playwright_tests/test_course_syllabus_1770.py::"
        "test_mobile_visitor_opens_nested_topic_and_lesson_with_keyboard",
        "playwright_tests/test_course_syllabus_1770.py::"
        "test_python_and_buildcamp_use_shared_top_level_syllabus_row_geometry",
    })
    ...
    issue_1778_owners = frozenset({
        ...
        "playwright_tests/test_homework_steps_1778.py::"
        "test_sidebar_exit_saves_latest_dirty_choice_before_navigation",
        "playwright_tests/test_homework_learning_public.py::"
    ...
    issue_1802_owners = frozenset({
        "playwright_tests/test_articles_blog.py::"
    ...
    issue_1556_owners = frozenset({
        "playwright_tests/test_studio_privacy_deletion_1556.py::"
        "test_superuser_follows_handoff_and_deletes_eligible_account",
        "playwright_tests/test_studio_privacy_deletion_1556.py::"
        "test_staff_reviewer_can_inspect_but_cannot_execute",
        "playwright_tests/test_studio_privacy_deletion_1556.py::"
        "test_active_subscription_is_a_truthful_retryable_blocker",
        "playwright_tests/test_studio_privacy_deletion_1556.py::"
        "test_protected_staff_account_cannot_be_deleted",
        "playwright_tests/test_studio_privacy_deletion_1556.py::"
        "test_stale_request_cannot_be_retargeted",
        "playwright_tests/test_studio_privacy_deletion_1556.py::"
        "test_two_tabs_converge_on_one_irreversible_action",
        "playwright_tests/test_studio_privacy_deletion_1556.py::"
        "test_known_confirmation_failure_is_visible_and_recoverable",
        "playwright_tests/test_studio_privacy_deletion_1556.py::"
    ...
    issue_1719_owners = frozenset({
        "playwright_tests/test_guest_layout_polish_1190.py::"
        "test_courses_two_card_catalog_grid_stays_left_aligned",
        "playwright_tests/test_guest_layout_polish_1190.py::"
        "test_courses_one_card_filtered_catalog_grid_stays_left_aligned",
        "playwright_tests/test_guest_layout_polish_1190.py::"
        "test_courses_sold_separately_single_card_grid_stays_left_aligned",
        "playwright_tests/test_guest_layout_polish_1190.py::"
        "test_courses_six_card_catalog_keeps_three_column_grid",
        "playwright_tests/test_guest_layout_polish_1190.py::"
    ...
    def test_reviewed_recap_owner_stays_in_browser_partition(self):
        ...
        for owner in PORT_RESOLUTION_POLICY_OWNER_IDS:
            ...
            self.assertNotIn(owner, manifest["LEGACY_DECLARED_BROWSER"])
            self.assertIn(owner, LEGACY_NON_BROWSER_CEILING)
        self.assertEqual(len(manifest["LEGACY_DECLARED_BROWSER"]), 2245)
    ...
    def test_current_collection_exactly_matches_live_partition_without_runtime_startup(self):
        ...
        for owner in self.issue_1565_owners:
            self.assertNotIn(owner, load_live_manifest()["LEGACY_DECLARED_BROWSER"])
            self.assertNotIn(owner, LEGACY_DECLARED_BROWSER_CEILING)
        for owner in self.issue_1566_owners:
            self.assertNotIn(owner, load_live_manifest()["LEGACY_DECLARED_BROWSER"])
            self.assertNotIn(owner, LEGACY_DECLARED_BROWSER_CEILING)
        for owner in (
            self.issue_1528_owners
