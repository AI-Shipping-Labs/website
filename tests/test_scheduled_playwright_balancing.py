...
EXPECTED_SOURCES = {
    31679060660: {
        ...
        "weights_digest": "2fc79e415a07f6dd636a5b618e2325e44b42977b6ddeea018fc590f43a97d3de",
    },
    31690316576: {
        ...
        "weights_digest": "74936780626ddccc4666259e6f9e8e1dea179c29ae70926a2cf130e6ae5ba7da",
    },
    31718675813: {
        ...
        "weights_digest": "c0313038ea4d08efacfc1d4ef7e053c9a93c22f8880a575caf7e2ad40d3b39c8",
    },
}
EXPECTED_INVENTORY_DIGEST = "bfd60383f0dff9b37117485bfa5e7bbd0bbdbf1d79eeae050011a8059af51c34"
SYNTHETIC_FILES = (
...
class ScheduledPlaywrightMeasuredBalanceTest(SimpleTestCase):
    def test_pinned_green_sources_and_raw_weight_digests_are_exact(self):
        ...
        self.assertEqual(len(manifest["file_weights_ms"]), 379)
    ...
    def test_measured_plan_is_stable_complete_disjoint_and_better_balanced(self):
        ...
        self.assertEqual(first.loads_ms, (888925, 888960, 888961, 889052))
        self.assertEqual([len(shard) for shard in first.files], [98, 93, 94, 94])

        baseline = round_robin_loads(inventory, measured, 4, first.unknown_weight_ms)
        self.assertEqual(baseline, (863191, 1131571, 700208, 860928))
